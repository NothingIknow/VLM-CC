...
- white-balance
model-index:
- name: nus-gehler-inter_qwen2.5vl-7b
  results: []
---

# VLM-CC · Qwen2.5-VL-7B direction LoRA (NUS-8, Gehler and Inter-tau)
...
This is a **cross-dataset** model: trained on **NUS-8, Gehler and Inter-tau** and intended for zero-shot evaluation on
the held-out **Cube+** benchmark.
...
NUS-8, Gehler and Inter-tau color-constancy datasets (16-bit sRGB, illuminant-direction labels).

...
- white-balance
model-index:
- name: gehler-cube-inter_qwen2.5vl-7b
  results: []
---

# VLM-CC · Qwen2.5-VL-7B direction LoRA (Gehler, Cube+ and Inter-tau)
...
This is a **cross-dataset** model: trained on **Gehler, Cube+ and Inter-tau** and intended for zero-shot evaluation on
the held-out **NUS-8** benchmark.
...
Gehler, Cube+ and Inter-tau color-constancy datasets (16-bit sRGB, illuminant-direction labels).
